        ...
        <div class="col-lg-9">
            <div class="card mb-4">
                <div class="card-body">
                        ...
                        <div class="carousel-inner">
                            @foreach(explode(',', $product->img_path) as $index => $image)
                                <div class="carousel-item {{ $index == 0 ? 'active' : '' }}">
                                    <img src="{{ asset(trim($image)) }}" class="d-block w-100" style="height: 150px; object-fit: contain;" alt="Product Image">
                                </div>
                            @endforeach
                        </div>
                    ...
                    <!-- Star Rating and Overall Rating Section -->
                    <div style="display: flex; align-items: center; margin-top: 10px;">
                        <div class="star-rating display-only" style="display: flex; margin-right: 10px;">
                            @for ($i = 5; $i >= 1; $i--)
