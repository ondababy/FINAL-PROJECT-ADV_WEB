...
<link rel="stylesheet" href="https://unpkg.com/leaflet@1.7.1/dist/leaflet.css" integrity="sha512-yto/jknFQwBgfqg40p+44gpRJd3V1p+M57zCfN1l1m2ZVQ7/zNMTb7J6c2Rqqn1hCVTHpy2tcV4AwwexM5gAlQ==" crossorigin="" />
<script src="https://unpkg.com/leaflet@1.7.1/dist/leaflet.js" integrity="sha512-XQoYMqMTK8LvdxXYG3nZ448hOEQiglfqkJs1NOQV44cWnUrBc8PkAOcXy20w0vlaXaVUearIOBhiXZ5V3ynxwA==" crossorigin=""></script>
<script>
    var mymap = L.map('mapid').setView([14.5995, 120.9842], 13);
    ...
    var marker = L.marker([14.5995, 120.9842], { draggable: true }).addTo(mymap)
        .bindPopup("<b>Shoessshable</b><br />Location.").openPopup();

    marker.on('dragend', function (e) {
        var position = marker.getLatLng();
        marker.setLatLng(position, { draggable: 'true' }).bindPopup("<b>Shoessshable</b><br />Location.<br>Lat: " + position.lat + "<br>Lng: " + position.lng).openPopup();
    });
